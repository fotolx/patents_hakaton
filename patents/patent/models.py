...
class IndustrialDesign(models.Model):
    ...
    registration_date = models.CharField(max_length=100,null=True,verbose_name='Дата регистрации')# = models.DateField(verbose_name='Дата регистрации')
    application_number = models.IntegerField(null=True)
    application_date = models.CharField(max_length=100,null=True,verbose_name='Дата публикации')# = models.DateField(verbose_name='Дата публикации')
    ...
    Crimean_industrial_design_application_date_for_state_registration_in_Ukraine = models.CharField(max_length=100,null=True,db_column='Crimean_industrial_design_application_date_for_state_registrati')
    Crimean_industrial_design_patent_number_in_Ukraine = models.CharField(max_length=100, null=True)
    receipt_date_of_additional_data_to_application = models.CharField(max_length=100,null=True)# = models.DateField(null=True)
    date_of_application_to_which_additional_data_has_been_received = models.CharField(max_length=100,null=True)# = models.DateField(null=True)
    ...
    initial_application_date  = models.CharField(max_length=100,null=True) #= models.DateField(null=True)
    initial_application_priority_date = models.CharField(max_length=100,null=True)# = models.DateField(null=True)
    previous_application_number = models.CharField(max_length=100,null=True)
    previous_application_date = models.CharField(max_length=100,null=True)# = models.DateField(null=True)
